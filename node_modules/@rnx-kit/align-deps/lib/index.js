...
// ../console/lib/index.js
var require_lib = __commonJS({
  "../console/lib/index.js"(exports) {
    "use strict";
    ...
    var error8 = (...args) => console.error(chalk_1.default.red.bold("error"), ...args);
    exports.error = error8;
    var info4 = (...args) => console.log(chalk_1.default.cyan.bold("info"), ...args);
    exports.info = info4;
    var warn6 = (...args) => console.warn(chalk_1.default.yellow.bold("warn"), ...args);
    exports.warn = warn6;
  }
});

// ../tools-language/lib/properties.js
var require_properties = __commonJS({
  "../tools-language/lib/properties.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.pickValues = exports.keysOf = exports.hasProperty = void 0;
    function hasProperty2(obj, property) {
      return typeof obj === "object" && obj !== null && property in obj;
    }
    exports.hasProperty = hasProperty2;
    function keysOf5(obj) {
      return obj ? Object.keys(obj) : [];
    }
    exports.keysOf = keysOf5;
...
// ../tools-language/properties.js
var require_properties2 = __commonJS({
  "../tools-language/properties.js"(exports, module2) {
...
var require_path_exists2 = __commonJS({
  "../../node_modules/pkg-up/node_modules/path-exists/index.js"(exports, module2) {
    "use strict";
    var fs3 = require("fs");
...
var require_p_limit2 = __commonJS({
  "../../node_modules/pkg-up/node_modules/p-limit/index.js"(exports, module2) {
    "use strict";
...
var require_p_locate2 = __commonJS({
  "../../node_modules/pkg-up/node_modules/p-locate/index.js"(exports, module2) {
    "use strict";
...
var require_locate_path2 = __commonJS({
  "../../node_modules/pkg-up/node_modules/locate-path/index.js"(exports, module2) {
    "use strict";
    var path6 = require("path");
...
var require_find_up2 = __commonJS({
  "../../node_modules/pkg-up/node_modules/find-up/index.js"(exports, module2) {
    "use strict";
    var path6 = require("path");
...
var require_pkg_up = __commonJS({
  "../../node_modules/pkg-up/index.js"(exports, module2) {
    "use strict";
...
// ../tools-node/lib/package.js
var require_package = __commonJS({
  "../tools-node/lib/package.js"(exports) {
    "use strict";
    ...
    function resolvePackagePath(pkgPath) {
      if (path6.basename(pkgPath).toLowerCase() !== "package.json") {
        return path6.join(pkgPath, "package.json");
      }
      return pkgPath;
    }
    function readPackage5(pkgPath) {
      const pkgFile = resolvePackagePath(pkgPath);
      return JSON.parse(fs3.readFileSync(pkgFile, "utf-8"));
    }
    exports.readPackage = readPackage5;
    function writePackage2(pkgPath, manifest, space = "  ") {
      const pkgFile = resolvePackagePath(pkgPath);
      fs3.writeFileSync(pkgFile, JSON.stringify(manifest, void 0, space) + "\n", "utf-8");
    }
    exports.writePackage = writePackage2;
    function findPackage(startDir) {
      var _a;
      return (_a = pkg_up_1.default.sync({ cwd: startDir ? startDir : process.cwd() })) !== null && _a !== void 0 ? _a : void 0;
    }
    exports.findPackage = findPackage;
    function findPackageDir2(startDir) {
      var _a;
      return (_a = pkg_dir_1.default.sync(startDir ? startDir : process.cwd())) !== null && _a !== void 0 ? _a : void 0;
    }
    exports.findPackageDir = findPackageDir2;
    function findPackageDependencyDir2(ref, options) {
      var _a;
      const pkgName = typeof ref === "string" ? ref : path6.join((_a = ref.scope) !== null && _a !== void 0 ? _a : "", ref.name);
      const packageDir = find_up_1.default.sync(path6.join("node_modules", pkgName), {
      ...
      return fs3.lstatSync(packageDir).isSymbolicLink() ? path6.resolve(path6.dirname(packageDir), fs3.readlinkSync(packageDir)) : packageDir;
    }
    exports.findPackageDependencyDir = findPackageDependencyDir2;
  }
});

// ../tools-node/package.js
var require_package2 = __commonJS({
  "../tools-node/package.js"(exports, module2) {
    module2.exports = require_package();
  }
});
    ...
    function readdir(directory, settings, callback) {
      settings.fs.readdir(directory, (readdirError, names) => {
        ...
        const tasks = names.map((name) => {
          ...
          return (done) => {
            fsStat.stat(path6, settings.fsStatSettings, (error8, stats) => {
              if (error8 !== null) {
                done(error8);
                return;
              }
      ...
      _getStat(filepath) {
        return new Promise((resolve2, reject) => {
          this._stat(filepath, this._fsStatSettings, (error8, stats) => {
            return error8 === null ? resolve2(stats) : reject(error8);
          });
        });
      }
    };
...
// ../tools-workspaces/lib/yarn.js
var require_yarn = __commonJS({
  "../tools-workspaces/lib/yarn.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    async function findWorkspacePackages2(lockfile) {
      const root = path6.dirname(lockfile);
      const manifest = await (0, common_1.readJSON)(path6.join(root, "package.json"));
      return await (0, common_1.findPackages)(parse(manifest), root);
    }
    exports.findWorkspacePackages = findWorkspacePackages2;
    function findWorkspacePackagesSync(lockfile) {
      const root = path6.dirname(lockfile);
      const manifest = (0, common_1.readJSONSync)(path6.join(root, "package.json"));
...
// ../tools-workspaces/lib/lerna.js
var require_lerna = __commonJS({
  "../tools-workspaces/lib/lerna.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    async function findWorkspacePackages2(configFile) {
      ...
      if (!useWorkspaces) {
        return await (0, common_1.findPackages)(packages, path6.dirname(configFile));
      }
      const root = path6.dirname(configFile);
      const sentinels = filterSentinels();
      for (const sentinel of sentinels) {
        const filename = path6.join(root, sentinel);
        if ((0, fs_1.existsSync)(filename)) {
          const { findWorkspacePackages: findWorkspacePackages3 } = await (0, common_1.getImplementation)(filename);
          return await findWorkspacePackages3(filename);
        }
      }
      return [];
    }
    ...
    function findWorkspacePackagesSync(configFile) {
      ...
      if (!useWorkspaces) {
        return (0, common_1.findPackagesSync)(packages, path6.dirname(configFile));
      }
      const root = path6.dirname(configFile);
      const sentinels = filterSentinels();
      for (const sentinel of sentinels) {
        const filename = path6.join(root, sentinel);
        if ((0, fs_1.existsSync)(filename)) {
          const { findWorkspacePackagesSync: findWorkspacePackagesSync2 } = (0, common_1.getImplementationSync)(filename);
          return findWorkspacePackagesSync2(filename);
        }
      }
      return [];
    }
...
var require_strip_bom = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/strip-bom/index.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/common.js
var require_common3 = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/common.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/exception.js
var require_exception = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/exception.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/snippet.js
var require_snippet = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/snippet.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type.js
var require_type = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema.js
var require_schema = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema.js"(exports, module2) {
    "use strict";
    var YAMLException = require_exception();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/str.js
var require_str = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/str.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/seq.js
var require_seq = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/seq.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/map.js
var require_map = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/map.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/failsafe.js
var require_failsafe = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/failsafe.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/null.js
var require_null = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/null.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/bool.js
var require_bool = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/bool.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/int.js
var require_int = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/int.js"(exports, module2) {
    "use strict";
    var common = require_common3();
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/float.js
var require_float = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/float.js"(exports, module2) {
    "use strict";
    var common = require_common3();
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/json.js
var require_json = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/json.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/core.js
var require_core = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/core.js"(exports, module2) {
    "use strict";
    module2.exports = require_json();
  }
});

// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/timestamp.js
var require_timestamp = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/timestamp.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/merge.js
var require_merge = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/merge.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/binary.js
var require_binary = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/binary.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/omap.js
var require_omap = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/omap.js"(exports, module2) {
    "use strict";
    var Type = require_type();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/pairs.js
var require_pairs = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/pairs.js"(exports, module2) {
    "use strict";
    var Type = require_type();
    var _toString = Object.prototype.toString;
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/set.js
var require_set = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/type/set.js"(exports, module2) {
    "use strict";
    var Type = require_type();
    var _hasOwnProperty = Object.prototype.hasOwnProperty;
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/default.js
var require_default = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/schema/default.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/loader.js
var require_loader = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/loader.js"(exports, module2) {
    "use strict";
    var common = require_common3();
    var YAMLException = require_exception();
...
// ../../node_modules/read-yaml-file/node_modules/js-yaml/lib/dumper.js
var require_dumper = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/lib/dumper.js"(exports, module2) {
    "use strict";
    var common = require_common3();
    var YAMLException = require_exception();
    var DEFAULT_SCHEMA = require_default();
...
var require_js_yaml = __commonJS({
  "../../node_modules/read-yaml-file/node_modules/js-yaml/index.js"(exports, module2) {
    "use strict";
...
var require_read_yaml_file = __commonJS({
  "../../node_modules/read-yaml-file/index.js"(exports, module2) {
    "use strict";
    var fs3 = require("fs");
    var stripBom = require_strip_bom();
    var yaml = require_js_yaml();
    var parse = (data) => yaml.load(stripBom(data));
    var readYamlFile = (fp) => fs3.promises.readFile(fp, "utf8").then((data) => parse(data));
    module2.exports = readYamlFile;
    module2.exports.default = readYamlFile;
    module2.exports.sync = (fp) => parse(fs3.readFileSync(fp, "utf8"));
  }
});

// ../tools-workspaces/lib/pnpm.js
var require_pnpm = __commonJS({
  "../tools-workspaces/lib/pnpm.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    exports.findWorkspacePackagesSync = exports.findWorkspacePackages = void 0;
    var path6 = __importStar(require("path"));
    var read_yaml_file_1 = __importStar(require_read_yaml_file());
    var common_1 = require_common4();
    async function findWorkspacePackages2(workspaceYaml) {
      const { packages } = await (0, read_yaml_file_1.default)(workspaceYaml);
      return await (0, common_1.findPackages)(packages, path6.dirname(workspaceYaml));
    }
    exports.findWorkspacePackages = findWorkspacePackages2;
    function findWorkspacePackagesSync(workspaceYaml) {
      const { packages } = (0, read_yaml_file_1.sync)(workspaceYaml);
      return (0, common_1.findPackagesSync)(packages, path6.dirname(workspaceYaml));
    }
    exports.findWorkspacePackagesSync = findWorkspacePackagesSync;
  }
});

// ../tools-workspaces/lib/rush.js
var require_rush = __commonJS({
  "../tools-workspaces/lib/rush.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function parse({ projects }, configFile) {
      const root = path6.dirname(configFile);
      return projects.map((project) => path6.join(root, project.projectFolder));
    }
    async function findWorkspacePackages2(configFile) {
...
// ../tools-workspaces/lib/common.js
var require_common4 = __commonJS({
  "../tools-workspaces/lib/common.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function dirnameAll(paths) {
      return paths.map((p) => path6.dirname(p));
    }
    ...
    function getImplementation(sentinel) {
      switch (path6.basename(sentinel)) {
        case exports.PACKAGE_LOCK_JSON:
        case exports.YARN_LOCK:
          return Promise.resolve().then(() => __importStar(require_yarn()));
        case exports.LERNA_JSON:
          return Promise.resolve().then(() => __importStar(require_lerna()));
        case exports.PNPM_WORKSPACE_YAML:
          return Promise.resolve().then(() => __importStar(require_pnpm()));
        case exports.RUSH_JSON:
          return Promise.resolve().then(() => __importStar(require_rush()));
      }
    ...
    async function readJSON(path7) {
      const json = await (0, promises_1.readFile)(path7, { encoding: "utf-8" });
      return JSON.parse((0, strip_json_comments_1.default)(json));
    }
    exports.readJSON = readJSON;
    function readJSONSync(path7) {
      const json = (0, fs_1.readFileSync)(path7, { encoding: "utf-8" });
      return JSON.parse((0, strip_json_comments_1.default)(json));
    }
...
// ../tools-workspaces/lib/index.js
var require_lib2 = __commonJS({
  "../tools-workspaces/lib/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var path6 = __importStar(require("path"));
    var common_1 = require_common4();
    async function findWorkspacePackages2() {
      const sentinel = await (0, common_1.findSentinel)();
      if (!sentinel) {
        return [];
      }
      const { findWorkspacePackages: findWorkspacePackages3 } = await (0, common_1.getImplementation)(sentinel);
      return await findWorkspacePackages3(sentinel);
    }
    exports.findWorkspacePackages = findWorkspacePackages2;
    function findWorkspacePackagesSync() {
      ...
      const { findWorkspacePackagesSync: findWorkspacePackagesSync2 } = (0, common_1.getImplementationSync)(sentinel);
      return findWorkspacePackagesSync2(sentinel);
    }
    exports.findWorkspacePackagesSync = findWorkspacePackagesSync;
    async function findWorkspaceRoot2() {
      const sentinel = await (0, common_1.findSentinel)();
      return sentinel && path6.dirname(sentinel);
    }
    exports.findWorkspaceRoot = findWorkspaceRoot2;
...
// ../config/lib/getBundleConfig.js
var require_getBundleConfig = __commonJS({
  "../config/lib/getBundleConfig.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getPlatformBundleConfig = exports.getBundleConfig = void 0;
    function failOnUnsupportedProp(parameters, name, message) {
      if (Object.prototype.hasOwnProperty.call(parameters, name)) {
        throw new Error(`The bundle configuration property '${name}' is no longer supported. ${message}`);
      }
    }
    function failOnRenamedProp(parameters, oldName, newName) {
      failOnUnsupportedProp(parameters, oldName, `Use '${newName}' instead.`);
    }
    function failOnUnsupportedProps(parameters) {
      ...
      failOnRenamedProp(parameters, "sourceMapSourceRootPath", "sourcemapSourcesRoot");
      failOnRenamedProp(parameters, "assetsPath", "assetsDest");
      failOnUnsupportedProp(parameters, "distPath", "You can control the bundle path and source-map path using 'bundleOutput' and 'sourcemapOutput', respectively.");
      failOnUnsupportedProp(parameters, "bundlePrefix", "You can control the bundle file name using 'bundleOutput'.");
    }
    function getBundleConfig(config, id) {
      if (!config.bundle) {
        return void 0;
      }
      if (config.bundle === true) {
        throw new Error(`The rnx-kit configuration property 'bundle' no longer supports boolean values. Bundling is always enabled with sensible defaults. You should remove the 'bundle' property to make use of the defaults, or specify the bundle configuration as an object.`);
      }
      const bundles = Array.isArray(config.bundle) ? config.bundle : [config.bundle];
      let bundle;
      if (id) {
        bundle = bundles.find((b) => b.id === id);
      } else {
        bundle = bundles.length > 0 ? bundles[0] : void 0;
      }
      if (!bundle) {
        return void 0;
      }
    ...
    function getPlatformBundleConfig(bundle, platform) {
      const platformValues = bundle.platforms ? bundle.platforms[platform] : void 0;
      return platformValues ? { ...bundle, ...platformValues } : bundle;
    }
    exports.getPlatformBundleConfig = getPlatformBundleConfig;
  }
});
...
// ../config/lib/getKitCapabilities.js
var require_getKitCapabilities = __commonJS({
  "../config/lib/getKitCapabilities.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getKitCapabilities = void 0;
    var console_1 = require_lib();
    var semver_1 = __importDefault(require_semver2());
    function getKitCapabilities2({ capabilities = [], kitType = "library", reactNativeVersion, reactNativeDevVersion: rawDevVersion, customProfiles }) {
      var _a;
      if (!reactNativeVersion || !semver_1.default.valid(reactNativeVersion) && !semver_1.default.validRange(reactNativeVersion)) {
        throw new Error(`'${reactNativeVersion}' is not a valid version range`);
      }
      if (kitType === "app" && rawDevVersion) {
        (0, console_1.warn)("'reactNativeDevVersion' is not used when 'kitType' is 'app'");
      }
      const reactNativeDevVersion = rawDevVersion || ((_a = semver_1.default.minVersion(reactNativeVersion)) === null || _a === void 0 ? void 0 : _a.version);
      if (!reactNativeDevVersion || !semver_1.default.subset(reactNativeDevVersion, reactNativeVersion)) {
    ...
    exports.getKitCapabilities = getKitCapabilities2;
  }
});

// ../tools-node/lib/module.js
var require_module = __commonJS({
  "../tools-node/lib/module.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// ../tools-node/lib/path.js
var require_path2 = __commonJS({
  "../tools-node/lib/path.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../tools-node/lib/index.js
var require_lib3 = __commonJS({
  "../tools-node/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "getPackageModuleRefFromModulePath", { enumerable: true, get: function() {
      return module_1.getPackageModuleRefFromModulePath;
    } });
    Object.defineProperty(exports, "isFileModuleRef", { enumerable: true, get: function() {
      return module_1.isFileModuleRef;
    } });
    Object.defineProperty(exports, "isPackageModuleRef", { enumerable: true, get: function() {
      return module_1.isPackageModuleRef;
    } });
    Object.defineProperty(exports, "parseModuleRef", { enumerable: true, get: function() {
      return module_1.parseModuleRef;
    } });
    var package_1 = require_package();
    Object.defineProperty(exports, "findPackage", { enumerable: true, get: function() {
      return package_1.findPackage;
    } });
    Object.defineProperty(exports, "findPackageDependencyDir", { enumerable: true, get: function() {
      return package_1.findPackageDependencyDir;
    } });
    Object.defineProperty(exports, "findPackageDir", { enumerable: true, get: function() {
      return package_1.findPackageDir;
    } });
    Object.defineProperty(exports, "parsePackageRef", { enumerable: true, get: function() {
      return package_1.parsePackageRef;
    } });
    Object.defineProperty(exports, "readPackage", { enumerable: true, get: function() {
      return package_1.readPackage;
    } });
    Object.defineProperty(exports, "writePackage", { enumerable: true, get: function() {
      return package_1.writePackage;
    } });
...
// ../config/lib/getKitConfig.js
var require_getKitConfig = __commonJS({
  "../config/lib/getKitConfig.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var path_1 = __importDefault(require("path"));
    var tools_node_1 = require_lib3();
    function getKitConfig3(options = {}) {
      const packageDir = options.module ? path_1.default.dirname(require.resolve(options.module + "/package.json")) : options.cwd || process.cwd();
      try {
    ...
    exports.getKitConfig = getKitConfig3;
  }
});
...
var require_lib4 = __commonJS({
  "../config/lib/index.js"(exports) {
    ...
    var getBundleConfig_1 = require_getBundleConfig();
    Object.defineProperty(exports, "getBundleConfig", { enumerable: true, get: function() {
      return getBundleConfig_1.getBundleConfig;
    } });
    Object.defineProperty(exports, "getPlatformBundleConfig", { enumerable: true, get: function() {
      return getBundleConfig_1.getPlatformBundleConfig;
    } });
    var getKitCapabilities_1 = require_getKitCapabilities();
    Object.defineProperty(exports, "getKitCapabilities", { enumerable: true, get: function() {
      return getKitCapabilities_1.getKitCapabilities;
    } });
    var getKitConfig_1 = require_getKitConfig();
    Object.defineProperty(exports, "getKitConfig", { enumerable: true, get: function() {
      return getKitConfig_1.getKitConfig;
    } });
  }
});
...
// ../tools-language/lib/index.js
var require_lib5 = __commonJS({
  "../tools-language/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.pickValues = exports.keysOf = exports.hasProperty = void 0;
    var properties_1 = require_properties();
    Object.defineProperty(exports, "hasProperty", { enumerable: true, get: function() {
      return properties_1.hasProperty;
    } });
    Object.defineProperty(exports, "keysOf", { enumerable: true, get: function() {
      return properties_1.keysOf;
    } });
    Object.defineProperty(exports, "pickValues", { enumerable: true, get: function() {
      return properties_1.pickValues;
    } });
  }
});
...
var require_prompts3 = __commonJS({
  "../../node_modules/prompts/index.js"(exports, module2) {
    ...
    module2.exports = isNodeLT("8.6.0") ? require_dist() : require_lib6();
  }
});
...
var require_build2 = __commonJS({
  "../../node_modules/yargs/node_modules/yargs-parser/build/index.cjs"(exports, module2) {
      ...
      parse(argsInput, options) {
        ...
        function eatNargs(i, key, args2, argAfterEqualSign) {
          ...
          if (toEat === 0) {
            if (!isUndefined(argAfterEqualSign)) {
              error8 = Error(__("Argument unexpected for: %s", key));
            }
            setArg(key, defaultValue(key));
            return i;
          }
          ...
          if (configuration["nargs-eats-options"]) {
            if (args2.length - (i + 1) + available < toEat) {
              error8 = Error(__("Not enough arguments following: %s", key));
            }
            available = toEat;
          } else {
            ...
            if (configPath) {
              try {
                ...
                if (ex.name === "PermissionDenied")
                  ...
                  error8 = Error(__("Invalid JSON config file: %s", configPath));
              }
            }
          });
        }
        ...
        function checkConfiguration() {
          Object.keys(flags.counts).find((key) => {
            if (checkAllAliases(key, flags.arrays)) {
              error8 = Error(__("Invalid configuration: %s, opts.count excludes opts.array.", key));
              return true;
            } else if (checkAllAliases(key, flags.nargs)) {
              error8 = Error(__("Invalid configuration: %s, opts.count excludes opts.narg.", key));
              return true;
            }
            return false;
          });
    ...
    var parser = new YargsParser({
      ...
      format: util.format,
      normalize: path6.normalize,
      resolve: path6.resolve,
      require: (path7) => {
        if (typeof require !== "undefined") {
          return require(path7);
        } else if (path7.match(/\.json$/)) {
          return fs3.readFileSync(path7, "utf8");
        } else {
...
var require_sync7 = __commonJS({
  "../../node_modules/escalade/sync/index.js"(exports, module2) {
    var { dirname: dirname5, resolve: resolve2 } = require("path");
...
var require_require_directory = __commonJS({
  "../../node_modules/require-directory/index.js"(exports, module2) {
    ...
    var dirname5 = require("path").dirname;
    var defaultOptions = {
    ...
    function checkFileInclusion(path6, filename, options) {
      return (
        ...
        !(options.include && options.include instanceof RegExp && !options.include.test(path6)) && // if options.include is a function, evaluate it and make sure the path passes
        !(options.include && typeof options.include === "function" && !options.include(path6, filename)) && // if options.exclude is a RegExp, evaluate it and make sure the path doesn't pass
        !(options.exclude && options.exclude instanceof RegExp && options.exclude.test(path6)) && // if options.exclude is a function, evaluate it and make sure the path doesn't pass
        !(options.exclude && typeof options.exclude === "function" && options.exclude(path6, filename))
      );
    }
    function requireDirectory(m, path6, options) {
      var retval = {};
      if (path6 && !options && typeof path6 !== "string") {
        options = path6;
        path6 = null;
      }
      options = options || {};
      ...
      path6 = !path6 ? dirname5(m.filename) : resolve2(dirname5(m.filename), path6);
      fs3.readdirSync(path6).forEach(function(filename) {
        var joined = join2(path6, filename), files, key, obj;
        ...
        if (commandHandler.handler && !yargs2._hasOutput()) {
          ...
          if (isPromise(handlerResult)) {
            ...
            handlerResult.then((value) => {
              ...
              try {
                yargs2.getUsageInstance().fail(null, error8);
              } catch (err) {
              }
            }).then(() => {
...
`;
    ...
    var cjsPlatformShim = {
      ...
      y18n: y18n({
        directory: resolve2(__dirname, "../locales"),
        updateFiles: false
      })
    };
    var minNodeVersion = process && process.env && process.env.YARGS_MIN_NODE_VERSION ? Number(process.env.YARGS_MIN_NODE_VERSION) : 10;
...
var baseCapabilities_default = baseCapabilities;
...
var profile_0_61_default = profile;
...
var profile_0_62_default = profile2;
...
var profile_0_63_default = profile3;
...
var profile_0_64_default = profile4;
...
var profile_0_65_default = profile5;
...
var profile_0_66_default = profile6;
...
var profile_0_67_default = profile7;
...
var profile_0_68_default = profile8;
...
var profile_0_69_default = profile9;
...
var profile_0_70_default = profile10;
...
var profile_0_71_default = profile11;
...
var profile_0_72_default = profile12;

// src/presets/microsoft/react-native.ts
var preset = {
  "0.61": profile_0_61_default,
  "0.62": profile_0_62_default,
  "0.63": profile_0_63_default,
  "0.64": profile_0_64_default,
  "0.65": profile_0_65_default,
  "0.66": profile_0_66_default,
  "0.67": profile_0_67_default,
  "0.68": profile_0_68_default,
  "0.69": profile_0_69_default,
  "0.70": profile_0_70_default,
  "0.71": profile_0_71_default,
  "0.72": profile_0_72_default
};
var react_native_default = preset;

// src/capabilities.ts
var import_console = __toESM(require_lib());
var import_properties = __toESM(require_properties2());
var ProvidesMeta = Symbol("provides");
function capabilitiesFor({
  ...
  for (const profile13 of Object.values(preset2)) {
    for (const capability of (0, import_properties.keysOf)(profile13)) {
      const { name } = profile13[capability];
...
function resolveCapability(capability, namedProfile, dependencies, unresolvedCapabilities, resolved = /* @__PURE__ */ new Set()) {
  ...
  const [profileName, profile13] = namedProfile;
  const pkg = profile13[capability];
  if (!pkg) {
  ...
  pkg.capabilities?.forEach(
    (capability2) => resolveCapability(
      capability2,
      namedProfile,
      dependencies,
...
function resolveCapabilities(manifestPath, capabilities, preset2) {
  ...
  if (unresolved.length > 0) {
    ...
    (0, import_console.warn)(message);
  }
  return dependencies;
}

// src/cli.ts
var import_console9 = __toESM(require_lib());
var import_properties4 = __toESM(require_properties2());
var import_package6 = __toESM(require_package2());
var import_tools_workspaces = __toESM(require_lib2());
var fs2 = __toESM(require("fs"));
var path5 = __toESM(require("path"));

// src/commands/check.ts
var import_console7 = __toESM(require_lib());
var import_package4 = __toESM(require_package2());
var path3 = __toESM(require("path"));

// src/compatibility/config.ts
var import_console3 = __toESM(require_lib());

// src/config.ts
var import_config = __toESM(require_lib4());
var import_console2 = __toESM(require_lib());
...
var banned_default = bannedPackages;

// src/findBadPackages.ts
function isBanned(name, version) {
  const info4 = banned_default.find((pkg) => pkg.name === name);
  return info4 && (0, import_subset.default)(version, info4.version) ? info4 : void 0;
}
function findBadPackages({
  ...
  const foundBadPackages = [
    ...
    peerDependencies,
    devDependencies
  ].reduce((badPackages, deps) => {
    if (deps) {
      for (const name of Object.keys(deps)) {
        const info4 = isBanned(name, deps[name]);
        if (info4) {
          badPackages.add(info4);
        }
      }
    }
    return badPackages;
  }, /* @__PURE__ */ new Set());
  return foundBadPackages.size > 0 ? Array.from(foundBadPackages) : void 0;
}
...
function loadConfig(manifestPath, { excludePackages }) {
  const manifest = (0, import_package.readPackage)(manifestPath);
...
` + badPackages.map((pkg) => `	${pkg.name}@${pkg.version}: ${pkg.reason}`).join("\n")
  ...
  try {
    const {
      ...
      reactNativeDevVersion,
      reactNativeVersion
    } = (0, import_config.getKitCapabilities)(config);
    return {
      kitType,
      reactNativeVersion,
...
function modifyManifest(pkgPath, manifest) {
  ...
  (0, import_package2.writePackage)(pkgPath, manifest, indent);
}
...
function migrateConfig(config, manifestPath, { migrateConfig: migrateConfig2 }) {
  ...
  if (migrateConfig2) {
    ...
    (0, import_console3.warn)(`${manifestPath}: The config schema has changed. Please update your config to the following:
...
// src/diff.ts
var import_tools_language = __toESM(require_lib5());
function diff(manifest, updatedManifest) {
  const allChanges = {
    dependencies: [],
    peerDependencies: [],
    devDependencies: []
  };
  const numChanges = (0, import_tools_language.keysOf)(allChanges).reduce((count, section) => {
...
// src/errors.ts
var import_console4 = __toESM(require_lib());
...
function printError(manifestPath, code) {
  switch (code) {
    case "success":
      break;
    case "excluded":
      (0, import_console4.info)(`${manifestPath} was ignored`);
      break;
    case "invalid-app-requirements":
      (0, import_console4.error)(
        `${manifestPath}: app requirements must resolve to a single profile`
      );
      break;
    case "invalid-configuration":
      (0, import_console4.error)(`${manifestPath}: align-deps was not properly configured`);
      break;
    ...
    case "missing-react-native":
      ...
      break;
    case "not-configured":
      (0, import_console4.error)(`${manifestPath}: align-deps was not configured`);
      break;
    case "unsatisfied":
      (0, import_console4.error)(`Re-run with '--write' to fix them.`);
      break;
  }
}
function printInfo() {
  const url = import_chalk.default.bold("https://aka.ms/align-deps");
  (0, import_console4.info)(`Visit ${url} for more information about align-deps.`);
}
...
// src/dependencies.ts
var import_config3 = __toESM(require_lib4());
var import_console5 = __toESM(require_lib());
...
function isDevOnlyCapability(capability, profiles) {
  return profiles.some((profile13) => profile13[capability]?.devOnly);
}
function visitDependencies({ dependencies }, projectRoot, visitor, visited = /* @__PURE__ */ new Set()) {
  ...
  Object.keys(dependencies).forEach((dependency) => {
    ...
    const packageDir = (0, import_package3.findPackageDependencyDir)(dependency, {
      startDir: projectRoot,
      resolveSymlinks: true
    });
    if (!packageDir) {
      (0, import_console5.warn)(`Unable to resolve module '${dependency}' from '${projectRoot}'`);
      return;
    }
    visitor(dependency, packageDir);
    const manifest = (0, import_package3.readPackage)(packageDir);
...
function gatherRequirements(projectRoot, manifest, preset2, requirements, appCapabilities, { loose }) {
  ...
  visitDependencies(manifest, projectRoot, (module2, modulePath) => {
    const kitConfig = (0, import_config3.getKitConfig)({ cwd: modulePath });
    if (!kitConfig) {
      return;
    }
    const requirements2 = (() => {
  ...
  if (trace[trace.length - 1].profiles.length === 0) {
    ...
    if (loose) {
      (0, import_console5.warn)(fullTrace);
    } else {
      (0, import_console5.error)(fullTrace);
...
// src/preset.ts
function loadPreset(preset2, projectRoot, resolve2 = require.resolve) {
  switch (preset2) {
    case "microsoft/react-native":
      return preset;
    default:
      return require(resolve2(preset2, { paths: [projectRoot] }));
  }
}
...
function filterPreset(preset2, requirements) {
  ...
  for (const [profileName, profile13] of Object.entries(preset2)) {
    const packages = Object.values(profile13);
    ...
    if (satisfiesRequirements) {
      filteredPreset[profileName] = profile13;
    }
  }
  return filteredPreset;
}
function mergePresets(presets2, projectRoot, resolve2 = require.resolve) {
  const mergedPreset = {};
  for (const presetName of presets2) {
    const preset2 = loadPreset(presetName, projectRoot, resolve2);
    for (const [profileName, profile13] of Object.entries(preset2)) {
...
function resolve({ kitType, alignDeps, manifest }, projectRoot, options) {
...
var import_console6 = __toESM(require_lib());
var import_properties2 = __toESM(require_properties2());
var path2 = __toESM(require("path"));
var import_subset2 = __toESM(require_subset());
function getAllCapabilities(preset2) {
  const capabilities = /* @__PURE__ */ new Set();
  for (const profile13 of Object.values(preset2)) {
    for (const capability of (0, import_properties2.keysOf)(profile13)) {
...
function isMisalignedPeer(from, to) {
  return from !== to && !(0, import_subset2.default)(to, from, { includePrerelease: true });
}
...
var buildManifestProfileCached = (() => {
  const profileCache = {};
...
function inspect(manifest, profile13, write) {
  const allChanges = {
    dependencies: [],
    peerDependencies: [],
    devDependencies: []
  ...
  const capabilities = {};
  const { unmanagedCapabilities } = profile13;
  const changesCount = (0, import_properties2.keysOf)(allChanges).reduce((count, section) => {
    const dependencies = manifest[section];
    if (!dependencies) {
      return count;
    }
    const isMisaligned = section === "peerDependencies" ? isMisalignedPeer : isMisalignedDirect;
    const desiredDependencies = profile13[section];
    const changes = allChanges[section];
...
function checkPackageManifestUnconfigured(manifestPath, { excludePackages, write }, config, logError = import_console6.error) {
  ...
  if (config.alignDeps.capabilities.length > 0 && unmanagedDependencies.length > 0) {
    const dependencies = unmanagedDependencies.map(([name, capability]) => {
      return `	  - ${name} can be managed by '${capability}'`;
    }).join("\n");
    (0, import_console6.warn)(
      `${manifestPath}: Found dependencies that are currently missing from capabilities:
${dependencies}`
    );
    (0, import_console6.info)(
...
// src/commands/check.ts
function checkPackageManifest(manifestPath, options, inputConfig = loadConfig(manifestPath, options), logError = import_console7.error) {
  ...
  return (manifest) => {
    ...
    if (!isError(config)) {
      ...
      for (const message of output) {
        (0, import_console7.error)(message);
      }
    ...
    if (config === "invalid-configuration" || config === "not-configured") {
      return checkPackageManifestUnconfigured(manifest, options, {
        ...
        manifest: (0, import_package4.readPackage)(manifest)
      });
    }
    return config;
  };
...
var import_console8 = __toESM(require_lib());
var import_package5 = __toESM(require_package2());
...
function makeInitializeCommand(kitType, options) {
  if (!isKitType(kitType)) {
    (0, import_console8.error)(`Invalid kit type: '${kitType}'`);
    return void 0;
  }
  return (manifestPath) => {
    const manifest = (0, import_package5.readPackage)(manifestPath);
    if (manifest["rnx-kit"]?.alignDeps) {
      return "success";
    }
    const updatedManifest = initializeConfig(
      manifest,
      path4.dirname(manifestPath),
      kitType,
      options
    );
    if (!updatedManifest) {
...
var import_properties3 = __toESM(require_properties2());
...
function parseVersions(versions) {
  return versions.split(",").map((v) => {
    ...
    if (!(parsedVersion in react_native_default)) {
      throw new Error(
...
async function parseInput(versions) {
  ...
  const { supportedVersions } = await (0, import_prompts.default)({
    ...
    choices: (0, import_properties3.keysOf)(react_native_default).map(toChoice),
    min: 1
  });
...
async function getManifests(packages) {
  ...
  if (Array.isArray(packages) && packages.length > 0) {
    const manifests = packages.reduce((result, input) => {
      ...
      if (!fs2.existsSync(pkg)) {
        (0, import_console9.error)(`${pkg}: No such file or directory`);
        return result;
      }
      const dir = (0, import_package6.findPackageDir)(pkg);
      if (dir) {
        const pkgJson = path5.join(dir, "package.json");
        const relativePath = path5.relative(cwd, pkgJson);
  ...
  const packageDir = (0, import_package6.findPackageDir)();
  if (!packageDir) {
    (0, import_console9.error)("Could not find package root");
    return void 0;
  }
  const currentPackageJson = path5.join(packageDir, "package.json");
  const manifestPath = path5.relative(cwd, currentPackageJson);
  try {
    if (await (0, import_tools_workspaces.findWorkspaceRoot)() !== packageDir) {
      return [manifestPath];
    }
  } catch (_) {
    return [manifestPath];
  ...
  try {
    const allPackages = (await (0, import_tools_workspaces.findWorkspacePackages)()).map(
      (p) => path5.join(path5.relative(cwd, p), "package.json")
    );
    allPackages.push(manifestPath);
    return allPackages;
  } catch (e) {
    if ((0, import_properties4.hasProperty)(e, "message")) {
      (0, import_console9.error)(e.message);
      return void 0;
    }
    throw e;
  }
...
function reportConflicts(conflicts, args) {
  return conflicts.reduce((result, [lhs, rhs]) => {
    if (lhs in args && rhs in args) {
      (0, import_console9.error)(`--${lhs} and --${rhs} cannot both be specified at the same time.`);
      return true;
    }
    return result;
  }, false);
...
async function cli({ packages, ...args }) {
  ...
  const errors = manifests.reduce((errors2, manifest) => {
    try {
      ...
      if ((0, import_properties4.hasProperty)(e, "message")) {
        (0, import_console9.error)(`${manifest}: ${e.message}`);
        return errors2 + 1;
      }
      throw e;
    }
